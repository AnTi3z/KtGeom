...
interface Geom2Factory<R : Number> {
    ...
    fun createPoint(src: Tuple2<Number>): Point2<R>
    fun createMutablePoint(src: Tuple2<Number>): MutablePoint2<R>

    fun createVector(x: Number, y: Number): Vector2<R>
    fun createMutableVector(x: Number, y: Number): MutableVector2<R>
    fun createVector(src: Tuple2<Number>): Vector2<R>
    fun createMutableVector(src: Tuple2<Number>): MutableVector2<R>

    fun createRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): Rect2<R>
    fun createMutableRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): MutableRect2<R>
    fun createRect(center: Tuple2<Number>, width: Number, height: Number): Rect2<R>
    fun createMutableRect(center: Tuple2<Number>, width: Number, height: Number): MutableRect2<R>
...
class Geom2DFactory : Geom2Factory<Double> {
    ...
    override fun createPoint(src: Tuple2<Number>): Point2<Double> = Point2D(src)
    override fun createMutablePoint(src: Tuple2<Number>): MutablePoint2<Double> = Point2D(src)
    ...
    override fun createVector(src: Tuple2<Number>): Vector2<Double> = Vector2D(src)
    override fun createMutableVector(src: Tuple2<Number>): MutableVector2<Double> = Vector2D(src)

    /** Rect2D creators  **/
    override fun createRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): Rect2<Double> =
        Rect2D.create(bottomLeft, topRight)

    override fun createMutableRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): MutableRect2<Double> =
        Rect2D.create(bottomLeft, topRight)

    override fun createRect(center: Tuple2<Number>, width: Number, height: Number): Rect2<Double> =
        Rect2D.create(center, width, height)

    override fun createMutableRect(center: Tuple2<Number>, width: Number, height: Number): MutableRect2<Double> =
        Rect2D.create(center, width, height)
...
class Geom2FFactory : Geom2Factory<Float> {
    ...
    override fun createPoint(src: Tuple2<Number>): Point2<Float> = Point2F(src)
    override fun createMutablePoint(src: Tuple2<Number>): MutablePoint2<Float> = Point2F(src)
    ...
    override fun createVector(src: Tuple2<Number>): Vector2<Float> = Vector2F(src)
    override fun createMutableVector(src: Tuple2<Number>): MutableVector2<Float> = Vector2F(src)

    /** Rect2F creators  **/
    override fun createRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): Rect2<Float> =
        Rect2F.create(bottomLeft, topRight)

    override fun createMutableRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): MutableRect2<Float> =
        Rect2F.create(bottomLeft, topRight)

    override fun createRect(center: Tuple2<Number>, width: Number, height: Number): Rect2<Float> =
        Rect2F.create(center, width, height)

    override fun createMutableRect(center: Tuple2<Number>, width: Number, height: Number): MutableRect2<Float> =
        Rect2F.create(center, width, height)
...
class Geom2IFactory : Geom2Factory<Int> {
    ...
    override fun createPoint(src: Tuple2<Number>): Point2<Int> = Point2I(src)
    override fun createMutablePoint(src: Tuple2<Number>): MutablePoint2<Int> = Point2I(src)
    ...
    override fun createVector(src: Tuple2<Number>): Vector2<Int> = Vector2I(src)
    override fun createMutableVector(src: Tuple2<Number>): MutableVector2<Int> = Vector2I(src)

    /** Rect2I creators  **/
    override fun createRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): Rect2<Int> =
        Rect2I.create(bottomLeft, topRight)

    override fun createMutableRect(bottomLeft: Tuple2<Number>, topRight: Tuple2<Number>): MutableRect2<Int> =
        Rect2I.create(bottomLeft, topRight)

    override fun createRect(center: Tuple2<Number>, width: Number, height: Number): Rect2<Int> =
        Rect2I.create(center, width, height)

    override fun createMutableRect(center: Tuple2<Number>, width: Number, height: Number): MutableRect2<Int> =
        Rect2I.create(center, width, height)

...
class Geom2DFactory : Geom2Factory<Double> {
    ...
    override fun <R: Number> createBounds(center: Tuple2<R>, width: Number, height: Number) = Bounds2D.create(center, width, height)
...
class Geom2FFactory : Geom2Factory<Float> {
    ...
    override fun <R: Number> createBounds(center: Tuple2<R>, width: Number, height: Number) = Bounds2F.create(center, width, height)
...
class Geom2IFactory : Geom2Factory<Int> {
    ...
    override fun <R: Number> createBounds(center: Tuple2<R>, width: Number, height: Number) = Bounds2I.create(center, width, height)
